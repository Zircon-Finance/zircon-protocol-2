...
//
//contract OldZirconPylonFactory is IZirconPylonFactory {
...
//        // Creating Token
//        bytes memory bytecode = type(OldZirconPylon).creationCode;
...
//        onlyMigrator();
//        OldZirconPylon(_oldPylon).migrateLiquidity(_newPylon);
//    }
//
//    function startPylon(address _pylon, uint _gamma, uint _vab, bool _formulaSwitch) external {
//        onlyMigrator();
//        OldZirconPylon(_pylon).initMigratedPylon(_gamma, _vab, _formulaSwitch);
//    }
//
//
...
//        }
//        OldZirconPylon(_pylonAddress).changeEnergyAddress(energy, _newEnergyRev);
//    }
//
