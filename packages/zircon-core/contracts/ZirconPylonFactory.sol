...
//        liquidityFee = 30;
    ...
    function startPylon(address _pylon, uint _gamma, uint _vab, uint _anchorK, bool _formulaSwitch) external {
        onlyMigrator();
        ZirconPylon(_pylon).initMigratedPylon(_gamma, _vab, _anchorK, _formulaSwitch);
    }
