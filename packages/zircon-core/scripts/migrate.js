...
const NEW_ENERGY_FACTORY = {1285: "0xB7adc6C137c6cCE6a6a20c76AE29984eaa224bEd", 1287: ''};
const PYLON_FACTORY = {1285: "0xe9DB6Edc6b4330e7C06f5A7F79822C1361d38548", 1287: '0x3fBb6ed3b8384fDdC18501BB62Ff3AdF50490E89'};
const GENESIS_PYLON_FACTORY = {1285: "0x4bA754989b77925F47e26C54aaa1b03Df23B32Ce", 1287: '0xbCea98Df85045F2Fcf5310fE4237ca95C9C24622'};
const NEW_PYLON_FACTORY = {1285: "0x7276DCC889c92234B0d2D2562DD9fD0E94d24248", 1287: ''};
...
const migratePylons = async () => {
    ...
    // NEW ENERGY
    let energyInstance2 = factoryEnergy.attach(NEW_ENERGY_FACTORY[chainId])//await factoryEnergy.deploy(FEE_TO_SETTER_ADDRESS, MIGRATOR_ADDRESS);
    ...
    const migrate = async (token0, token1, pylonAddress, pair) => {
        ...
        if (checkAdd === "0x0000000000000000000000000000000000000000") {
            await migrator.migrate(newFactoryPylonInstance.address, energyInstance2.address, token0, token1, GENESIS_PYLON_FACTORY[chainId]);
