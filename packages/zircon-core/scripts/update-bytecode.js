...
async function updateBytecode(libraryAddress) {
    try {
        ...
        console.log("\x1b[37m%s\x1b[0m", "PYLON: ", pylonBytecode);
        console.log("\x1b[37m%s\x1b[0m", "ENERGY: ", energyBytecode);
        console.log("\x1b[37m%s\x1b[0m", "PAIR: ", pairBytecode);
        console.log("\x1b[37m%s\x1b[0m", "PT: ", ptBytecode);
        ...
        // await fs.promises.writeFile(energyFactoryPath, resultPylon, 'utf8')
        await fs.promises.writeFile(energyFactoryPath, resultEnergy, 'utf8')

        console.log("\x1b[32m%s\x1b[0m", "SUCCESSFULLY UPDATED", "ZirconEnergyFactory.sol");
        ...
        console.log("\x1b[32m%s\x1b[0m", "SUCCESSFULLY UPDATED", "ZirconPeripheralLibrary.sol");
        ...
        console.log("\x1b[32m%s\x1b[0m", "SUCCESSFULLY UPDATED", "UniswapV2Library.sol");
