...
```solidity
function sendSlashing(uint256 omegaMulDecimals, uint256 liquidity, address _to) private returns (uint256 remainingPercentage)
```
...
```solidity
function preBurn(bool isAnchor, uint256 _totalSupply, uint256 _liquidity) private view returns (uint256 reservePT, uint256 amount)
```
...
```solidity
function handleOmegaSlashing(uint256 ptu, address _to) private returns (uint256 retPtu, uint256 extraPercentage)
```
...
```solidity
function calculatePTU(bool _isAnchor, uint256 _amount, uint256 _totalSupply, uint256 _reserve, uint256 _reservePylon, uint256 _gamma, uint256 _vab) internal view returns (uint256 liquidity)
```
